        ...
        children: [
          Stack(
            ...
            children: [
              ...
              if (model.price.previous.value != 0 || model.price.rrp.value != 0)
                DiscountSign(
                  model: model,
                ),
            ],
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            ...
                            style:  TextStyle(
                              color: (model.price.previous.value != 0 || model.price.rrp.value != 0)? ColorManager.pink:ColorManager.black,
